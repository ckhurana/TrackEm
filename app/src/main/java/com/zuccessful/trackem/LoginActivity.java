...
public class LoginActivity extends AppCompatActivity {
    ...
    public static final String HT_QUICK_START_SHARED_PREFS_KEY = "com.zuccessful.trackem:SharedPreference";
